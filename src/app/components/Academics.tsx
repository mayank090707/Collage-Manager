    ...
    <div className="p-8 space-y-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="bg-[#111118]/80 border border-gray-800/50 p-1 h-auto">
          <TabsTrigger
            value="attendance"
            className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#00d4ff]/20 data-[state=active]:to-[#a855f7]/20 data-[state=active]:text-[#00d4ff] data-[state=active]:shadow-[0_0_10px_rgba(0,212,255,0.2)] text-gray-400"
          >
            Attendance
          </TabsTrigger>
          <TabsTrigger
